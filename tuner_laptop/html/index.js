...
$(function(){
	...
	$("#boost").slider({min:0.1,value:0.25,step:0.01,max:1.75,change:sliderUpdated});
	$("#fuelmix").slider({min:1,value:1.3,step:0.01,max:3,change:sliderUpdated});
	$("#gearchange").slider({min:1,value:9,max:50,change:sliderUpdated});
	$("#braking").slider({value:0.5,max:2,step:0.05,change:sliderUpdated});
	$("#drivetrain").slider({value:0.5,max:2,step:0.05,change:sliderUpdated});
	$("#brakeforce").slider({value:1.4,max:3,step:0.05,change:sliderUpdated});
